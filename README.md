...
Exercícios e desafios práticos para treinar lógica e fundamentos de Python.
...
| Arquivo | Descrição |
|---|---|
| `media-escolar.py` | Cálculo de média de alunos |
| `semafaro.py` | Simulação de semáforo |
| `vamos-jogar.py` | Jogo simples interativo |

#### 📦 Desafio: Controle de Estoque

Projeto simples simulando um sistema de controle de estoque:

- Cadastro de produtos
- Controle de quantidade
- Organização em estrutura de programa

#### 🌐 Site (HTML + CSS)

Projeto introdutório de site simples com:
